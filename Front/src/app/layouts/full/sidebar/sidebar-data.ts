...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        displayName: 'calendar-dialog',
        iconName: 'solar:round-alt-arrow-right-line-duotone',
        route: '/ui-components/calendar-dialog',
      },
      {
        displayName: 'calendar-time',
        iconName: 'solar:round-alt-arrow-right-line-duotone',
        route: '/ui-components/calendar-time',
      },
      {
        displayName: 'Detail',
        iconName: 'point',
  ...
  },
  {
    ...
    iconName: 'info-circle',
    route: '/ui-components/crud',
  },
  {
    displayName: 'Crud Table Backend',
    iconName: 'file-text-ai',
    route: '/ui-components/backed',
  },
  {
    displayName: 'Grafico',
    iconName: 'chart-dots',
    route: '/ui-components/grafico',
  },
  {
    displayName: 'Video Lineal',
    iconName: 'archive',
    route: '/ui-components/video',
  },
  {
    displayName: 'Grafico Bar',
    iconName: 'chart-dots',
    route: '/ui-components/grafico-bar',
  },
  {
    displayName: 'Lists',
    iconName: 'list-details',
